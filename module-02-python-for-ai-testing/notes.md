...
jupyter notebook examples/day1_python_quickstart.ipynb
```
  ...
  test:
    ...
    steps:
      ...
      - name: Run LLM tests
        ...
        run: |
          cd module-02-python-for-ai-testing/examples/day6_framework
...
Exercise: [`exercises/day7_exercise.md`](exercises/day7_exercise.md)
